...
@section('page-title')
    ZenBlog Bootstrap Template - Index
@endsection
                    ...
                    <div class="col-md-9 order-md-2">
                        ...
                        <div class="d-lg-flex post-entry-2">
                            <a href="single-post.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                                <img src="{{ asset('frontend/assets/img/post-landscape-3.jpg') }}" alt=""
                                    class="img-fluid">
                            </a>
                            <a href="single-post.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                                <img src="{{ asset('frontend/assets/img/post-landscape-3.jpg') }}" alt=""
                            ...
                            <div>
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat
                                    ...
                                    deserunt aliquam temporibus sapiente, laudantium dolorum itaque libero eos deleniti?</p>
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="{{ asset('frontend/assets/img/person-4.jpg') }}"
                                            alt="" class="img-fluid"></div>
                                    <div class="name">
                                        <h3 class="m-0 p-0">Wade Warren</h3>
                                    </div>
        ...
        <section class="category-section">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            <a href="single-post.html"><img src="{{ asset('frontend/assets/img/post-landscape-8.jpg') }}"
                                    alt="" class="img-fluid"></a>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{ asset('frontend/assets/img/person-7.jpg') }}"
                                        alt="" class="img-fluid"></div>
